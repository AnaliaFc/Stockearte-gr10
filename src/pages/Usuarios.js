...
const ListarUsuarios = () => {
    ...
    return (
        ...
        <div className="container-house">
          <Helmet>
            <title>Ver Usuarios | Stockearte</title>
          </Helmet>
          <Menu /> 
            <Grid2 container spacing={2}>
                ...
                <h1 className="mb-3 text-center">Listado Productos</h1>
                </div>
                <Stack gap = {2}>
                <InputGroup className="mb-3" size="sm">
                <InputGroup.Text id="inputGroup-sizing-sm">Busqueda por NOMBRE:&nbsp;</InputGroup.Text>
                ...
                <Table data={data} theme={theme} pagination={pagination}>
                    {(tableList) => (
                        ...
                        <Body>
                            ...
                            <Row item={item}>
                            <Cell>{item.nombreUsuario}</Cell>
                            <Cell>{item.tienda.codigo}</Cell>
                            <Cell>{item.habilitado}</Cell>           
                            </Row>
                            </React.Fragment>
